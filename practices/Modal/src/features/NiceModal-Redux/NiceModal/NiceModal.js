...
import { showModal,hideModal } from './niceModalActions';
...
export const useNiceModal = (modalId)=>{
    ...
    const args = useSelector(state=>state['nice-modal'][modalId]);
    const hiding = useSelector(state=>state['nice-modal'].hiding[modalId]);
